...
class ItParts(models.Model):
    part_id = models.AutoField(db_column='Part_ID', primary_key=True)  # Field name made lowercase.
    name = models.CharField(max_length=255, blank=True, null=True)
    location_id = models.IntegerField(db_column='Location_ID', blank=True, null=True)  # Field name made lowercase.
